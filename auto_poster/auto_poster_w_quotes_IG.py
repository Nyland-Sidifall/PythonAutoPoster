...
uname = 'Your Username'
pword = 'Your Password'
imagePath = 'auto_poster/Quote_Pictures/image.jpg'
...
bgFileName = os.path.join(dirname, 'Background_Images/bg_1c.jpg')
...
#Save Image
image.save("auto_poster/Quote_Pictures/image.jpg")

bot.upload_photo(imagePath,caption='Quote of the Day!')
#bot.upload_story_photo(imagePath)
